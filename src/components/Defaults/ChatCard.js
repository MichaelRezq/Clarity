...
const ChatCard = () => {
  return (
    <div>
      {/* Mirrored from uitheme.net/sociala/default-message.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:30:30 GMT */}
      <meta charSet="UTF-8" />
      ...
      {/* Mirrored from uitheme.net/sociala/default-message.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:30:32 GMT */}
    </div>
  );
};
