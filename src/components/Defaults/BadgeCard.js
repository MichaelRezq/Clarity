...
const DefaultBadge = () => {
  return (
    <div>
      {/* Mirrored from uitheme.net/sociala/default-badge.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:22:08 GMT */}
      <meta charSet="UTF-8" />
                      ...
                      <div className="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                        <div className="card-body d-block w-100 p-4 text-center">
                          ...
                          <ul className="d-flex align-items-center justify-content-center mt-1">
                            ...
                            <li className="m-1">
                              <img
                                src="images/challenge-medal.svg"
                                alt="icon"
                              />
                            </li>
                            <li className="m-1">
      ...
      {/* Mirrored from uitheme.net/sociala/default-badge.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:22:29 GMT */}
    </div>
  );
};
