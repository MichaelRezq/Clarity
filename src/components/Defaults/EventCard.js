...
const Events = () => {
  return (
    <div>
      {/* Mirrored from uitheme.net/sociala/default-event.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:31:57 GMT */}
      <meta charSet="UTF-8" />
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card w-100 border-0 shadow-none rounded-xxl border-0 mb-3 overflow-hidden ">
                    <div id="map" className="rounded-3 h400" />
                  </div>
                  <div className="row">
                    <div className="col-lg-4 col-md-6 pe-2 ps-2">
                        ...
                        <div className="card-body d-flex ps-0 pe-0 pb-0">
                          ...
                          <h2 className="fw-700 lh-3 font-xss">
                            ...
                            <span className="d-flex font-xssss fw-500 mt-2 lh-3 text-grey-500">
                              {" "}
                              <i className="ti-location-pin me-1" /> Goa, Mumbai{" "}
                            </span>
                          </h2>
                        </div>
      ...
      {/* Mirrored from uitheme.net/sociala/default-event.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:31:58 GMT */}
    </div>
  );
};
