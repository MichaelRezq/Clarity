...
const Group = () => {
  return (
    <div>
      {/* Mirrored from uitheme.net/sociala/default-group.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:23:25 GMT */}
      <meta charSet="UTF-8" />
      ...
      <div className="main-wrapper">
        ...
        <div className="nav-header bg-white shadow-xs border-0">
          ...
          <a
            ...
            className="p-2 text-center ms-0 menu-icon center-menu-icon"
          >
            <i className="feather-user font-lg alert-primary btn-round-lg theme-dark-bg text-current " />
          </a>
          <a
            href="shop-2.html"
            className="p-2 text-center ms-0 menu-icon center-menu-icon"
                  ...
                  <div className="row ps-2 pe-1">
                    ...
                    <div className="col-md-6 col-sm-6 pe-2 ps-2">
                      <div className="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                        <div
                          className="card-body position-relative h100 bg-image-cover bg-image-center"
                          style={{ backgroundImage: "url(images/e-3.jpg)" }}
                        />
                        <div className="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                          <figure
                            className="avatar position-absolute w75 z-index-1"
                    ...
                    <div className="col-md-6 col-sm-6 pe-2 ps-2">
                      <div className="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                        <div
                          className="card-body position-relative h100 bg-image-cover bg-image-center"
                          style={{ backgroundImage: "url(images/e-1.jpg)" }}
                        />
                        <div className="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                          <figure
                            className="avatar position-absolute w75 z-index-1"
                    ...
                    <div className="col-md-6 col-sm-6 pe-2 ps-2">
                      <div className="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                        <div
                          className="card-body position-relative h100 bg-image-cover bg-image-center"
                          style={{ backgroundImage: "url(images/e-2.jpg)" }}
                        />
                        <div className="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                          <figure
                            className="avatar position-absolute w75 z-index-1"
      ...
      {/* Mirrored from uitheme.net/sociala/default-group.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:23:33 GMT */}
    </div>
  );
};
