...
const DefaultAnalytics = () => {
  return (
    <div>
      {/* Mirrored from uitheme.net/sociala/default-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:30:05 GMT */}
      <meta charSet="UTF-8" />
                ...
                <div className="col-xl-12 ">
                  <div className="row">
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-6 ps-lg-5">
                            ...
                            <p className="font-xssss fw-500 text-grey-500 lh-26">
                              After completing this course you'll be confident
                              to create any subtle to complex animation that
                              will turn any project a professional work.
                            </p>
                            <a
                              href="#"
                    ...
                    <div className="col-lg-3 pe-2 ps-2">
                      ...
                      >
                        <div className="card-body d-flex p-0">
                          <i className="btn-round-lg d-inline-block me-3 bg-secondary feather-lock font-md text-white" />
                    ...
                    <div className="col-lg-3 pe-2 ps-2">
                      ...
                      >
                        <div className="card-body d-flex p-0">
                          <i className="btn-round-lg d-inline-block me-3 bg-success feather-command font-md text-white" />
                    ...
                    <div className="col-lg-3 ps-2">
                      ...
                      >
                        <div className="card-body d-flex p-0">
                          <i className="btn-round-lg d-inline-block me-3 bg-warning feather-shopping-bag font-md text-white" />
                    ...
                    <div className="col-lg-12">
                      <div className="card w-100 p-3 border-0 mb-3 rounded-xxl bg-lightblue2 shadow-none overflow-hidden">
                        <div id="chart-usersMultiplee" />
                      </div>
                    </div>
                    <div className="col-lg-12">
                      <div className="card w-100 p-5 border-0 mb-3 rounded-lg bg-lightblue2 shadow-xs overflow-hidden">
      ...
      {/* Mirrored from uitheme.net/sociala/default-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:30:29 GMT */}
    </div>
  );
};
