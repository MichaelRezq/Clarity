    ...
    <div className="row">
      ...
      <div className="col-xl-3">
        <div className="forum-right-sidebar-widget question-sidebar">
          ...
          <div className="single-widget-box top-user mt-40">
            <div className="widget-header">
              <img src={require("../../Assets/Problems/user-icon.png")} alt="icon" />
              <h5>Ama User</h5>
            </div>
            <div className="widget-content">
              <div className="mb-4">
                <select className="custom-select nav nav-tabs" id="nav-tab">
                  <option id="nav-daily-tab" data-bs-toggle="tab" data-bs-target="#nav-daily" aria-controls="nav-daily" aria-selected="true" value="daily ranking">
                    daily ranking
                  </option>
                  <option id="nav-weekly-tab" data-bs-toggle="tab" data-bs-target="#nav-weekly" aria-controls="nav-weekly" aria-selected="false" value="weekly ranking">
                    weekly ranking
                  </option>
                  <option id="nav-monthly-tab" data-bs-toggle="tab" data-bs-target="#nav-month" aria-controls="nav-month" aria-selected="false" value="monthly ranking">
                    monthly ranking
                  </option>
                </select>
              </div>
              <div className="tab-content" id="nav-tabContent">
                <div className="tab-pane fade show active" id="nav-daily" role="tabpanel" aria-labelledby="nav-daily-tab">
                  <ul className="list-unstyled user-list">
                    <li>
                      1
                      <img src={require("../../Assets/Problems/forum/top-user/user-1.png")} alt /><a href="forum-profile.html">Craig
                        Levin</a><span>750
                        pts</span>
                    </li>
                    <li>
                      2
                      <img src={require("../../Assets/Problems/forum/top-user/user-2.png")} alt /><a href="forum-profile.html">Kadin
                        George</a><span>690
                        pts</span>
                    </li>
                    <li>
                      3
                      <img src={require("../../Assets/Problems/forum/top-user/user-3.png")} alt /><a href="forum-profile.html">Hanna
                        Rosser</a><span>650
                        pts</span>
                    </li>
                    <li>
                      4
                      <img src={require("../../Assets/Problems/forum/top-user/user-4.png")} alt /><a href="forum-profile.html">Phillip Carder</a><span>500
                        pts</span>
                    </li>
                    <li>
                      5
                      <img src={require("../../Assets/Problems/forum/top-user/user-5.png")} alt /><a href="forum-profile.html">Jaxson
                        Rhiel</a><span>425
                        pts</span>
                    </li>
                    <li>
                      6
                      <img src={require("../../Assets/Problems/forum/top-user/user-6.png")} alt /><a href="forum-profile.html">Marley
                        Rhiel</a><span>399
                        pts</span>
                    </li>
                  </ul>
                ...
                <div className="tab-pane fade" id="nav-weekly" role="tabpanel" aria-labelledby="nav-weekly-tab">
                  <ul className="list-unstyled user-list">
                    ...
                    <li>
                      2
                      <img src={require("../../Assets/Problems/forum/top-user/user-4.png")} alt /><a href="forum-profile.html">Martin
                        Garrix</a><span>500
                        pts</span>
                    </li>
                    <li>
                      3
                      <img src={require("../../Assets/Problems/forum/top-user/user-2.png")} alt /><a href="forum-profile.html">Avicii</a><span>690 pts</span>
                    </li>
                    <li>
                      4
                      <img src={require("../../Assets/Problems/forum/top-user/user-3.png")} alt /><a href="forum-profile.html">Hanna
                ...
                <div className="tab-pane fade" id="nav-month" role="tabpanel" aria-labelledby="nav-monthly-tab">
                  <ul className="list-unstyled user-list">
                    <li>
                      1
                      <img src={require("../../Assets/Problems/forum/top-user/user-4.png")} alt /><a href="forum-profile.html">Phillip Kappa</a><span>500
                        pts</span>
                    </li>
                    <li>
                      2
                    ...
                    <li>
                      3
                      <img src={require("../../Assets/Problems/forum/top-user/user-3.png")} alt /><a href="forum-profile.html">Tylor
                        Swift</a><span>650
                        pts</span>
                    </li>
                    <li>
                      4
                      <img src={require("../../Assets/Problems/forum/top-user/user-1.png")} alt /><a href="forum-profile.html">Tony
                        Stark</a><span>750
                        pts</span>
                    </li>
                    <li>
                    ...
                    <li>
                      6
                      <img src={require("../../Assets/Problems/forum/top-user/user-2.png")} alt /><a href="forum-profile.html">Steve
                        Aoki</a><span>690
                        pts</span>
                    </li>
                  </ul>
