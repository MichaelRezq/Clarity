...
const HotelDatails = () => {
  return (
    <div>
      <div>
        {/* Mirrored from uitheme.net/sociala/default-hotel-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:31:39 GMT */}
        <meta charSet="UTF-8" />
                  ...
                  <div className="col-xl-8 col-xxl-9 col-lg-8">
                    <div className="card d-block mt-4 border-0 shadow-xss bg-white p-lg-5 p-4">
                      ...
                      <h5 className="mt-4 mb-4 d-inline-block font-xssss fw-600 text-grey-500 me-2">
                        <i className="btn-round-sm bg-greylight ti-ruler-pencil text-grey-500 me-1" />{" "}
                        200 sq
                      </h5>
                      <h5 className="mt-4 mb-4 d-inline-block font-xssss fw-600 text-grey-500 me-2">
                        <i className="btn-round-sm bg-greylight ti-rss-alt text-grey-500 me-1" />{" "}
                        WiFi
                      </h5>
                    ...
                    <div className="card d-block border-0 rounded-3 overflow-hidden p-4 shadow-xss mt-4">
                      ...
                      <div className="row ps-3 pe-3">
                        <div className="col-sm-4 col-xss-4 pe-1 ps-1 mb-2">
                          <a href="images/p-1.jpg" data-lightbox="roadtrip">
                            <img
                              src="images/p-1.jpg"
                              alt="image"
                        ...
                        <div className="col-sm-4 col-xss-4 pe-1 ps-1 mb-2">
                          <a href="images/p-2.jpg" data-lightbox="roadtrip">
                            <img
                              src="images/p-2.jpg"
                              alt="image"
                              className="img-fluid w-100 rounded-3"
                        ...
                        <div className="col-sm-4 col-xss-4 pe-1 ps-1 mb-2">
                          <a href="images/p-3.jpg" data-lightbox="roadtrip">
                            <img
                              src="images/p-3.jpg"
                              alt="image"
                              className="img-fluid w-100 rounded-3"
                        ...
                        <div className="col-sm-4 col-xss-4 pe-1 ps-1 mb-2">
                          <a href="images/p-4.jpg" data-lightbox="roadtrip">
                            <img
                              src="images/p-4.jpg"
                              alt="image"
                              className="img-fluid w-100 rounded-3"
                        ...
                        <div className="col-sm-4 col-xss-4 pe-1 ps-1 mb-2">
                          <a href="images/p-5.jpg" data-lightbox="roadtrip">
                            <img
                              src="images/p-5.jpg"
                              alt="image"
                              className="img-fluid w-100 rounded-3"
                        ...
                        <div className="col-sm-4 col-xss-4 pe-1 ps-1 mb-2">
                          <a href="images/p-6.jpg" data-lightbox="roadtrip">
                            <img
                              src="images/p-6.jpg"
                              alt="image"
                              className="img-fluid w-100 rounded-3"
        ...
        {/* Mirrored from uitheme.net/sociala/default-hotel-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Mar 2023 23:31:57 GMT */}
      </div>
    </div>
  );
};
